...
class IoDeviceController(private val deviceService: DeviceService) : IodevicesApi {
    ...
    override fun getIoDevice(id: Int, include: List<String>) = ResponseEntity.ok(deviceService.get(id))
    ...
    override fun getIoDevices(include: List<String>) = ResponseEntity.ok(deviceService.all)
